...
import x590.yava.instruction.*;
import x590.yava.instruction.array.*;
import x590.yava.instruction.cast.CheckCastInstruction;
import x590.yava.instruction.constant.*;
import x590.yava.instruction.field.*;
...
//			case 0xA9 -> ret(readUnsignedByte());
			...
			case 0xB9 -> new InvokeinterfaceInstruction(this, readUnsignedShort(), readUnsignedByte(), readUnsignedByte());
