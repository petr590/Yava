package x590.yava.operation.cast;
...
public class CastOperation extends AbstractOperation {
	...
	public static Operation of(Type requiredType, Type castedType, boolean implicitCast, Operation operand) {
		...
		if (operand instanceof CastOperation castOperation &&
				castedType.isGenericType() && castedType.isDefinitelySubtypeOf(castOperation.castedType)) {

			return new CastOperation(castOperation.requiredType, castedType, implicitCast, castOperation.operand);
		}
