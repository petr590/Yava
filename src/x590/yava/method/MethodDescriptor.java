...
import x590.yava.exception.decompilation.IllegalMethodHeaderException;
...
public final class MethodDescriptor extends Descriptor<MethodDescriptor> implements Importable, JavaSerializableWithPool {
	...
	public static MethodDescriptor from(RealReferenceType declaringClass, AssemblingInputStream in) {
		return of(in.nextType(), declaringClass, in.nextName(), in.nextMethodArguments().toList());
	}
	...
	public String toString() {
		return returnType.getName() + ' ' +
				...
				toStringIgnoreClassAndReturnType();
	}

	public String toStringIgnoreClass() {
		return returnType.getName() + ' ' +
				toStringIgnoreClassAndReturnType();
	}

	public String toStringIgnoreClassAndReturnType() {
		return kind == MethodKind.STATIC_INITIALIZER ?
				"static {}" :
