...
import x590.yava.exception.decompilation.VariableNotFoundException;
import x590.yava.io.StringifyOutputStream;
import x590.yava.main.Yava;
import x590.yava.operation.AbstractOperation;
import x590.yava.operation.Operation;
import x590.yava.operation.store.StoreOperation;
import x590.yava.operation.variable.VariableDefineOperation;
import x590.yava.type.Type;
import x590.yava.type.primitive.PrimitiveType;
import x590.yava.variable.EmptyableVariable;
import x590.yava.variable.UnnamedVariable;
import x590.yava.variable.Variable;
import x590.yava.variable.VariableWrapper;
import x590.yava.variable.EmptyableVariableWrapper;
...
public abstract class Scope extends AbstractOperation {
	...
	/** Можно ли использовать {@code break} для этого scope */
	public boolean isBreakable() {
		return false;
	}
	
	/** Можно ли использовать {@code continue} для этого scope */
	...
	protected boolean canOmitCurlyBrackets() {
		return Yava.getConfig().canOmitCurlyBrackets() &&
