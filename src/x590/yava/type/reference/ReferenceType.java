...
import x590.yava.type.reference.generic.IndefiniteGenericType;
...
public abstract class ReferenceType extends BasicType {
	...
	@Override
	public ArrayType arrayType(int nestingLevel) {
	 ...
	 *
	 * @return {@code true}, если это так, {@code false} в противном случае
	...
	/**
	 * @return Супертип текущего типа или {@code null}, если супертип неизвестен
	 */
	public abstract @Nullable ReferenceType getSuperType();

	/**
	 * @return Супертип текущего типа с generic параметрами или {@code null}, если супертип неизвестен
	 */
	 ...
	 * или {@code null}, если интерфейсы неизвестны
	 */
...
//			ReferenceType prevType, GenericParameters<? extends ReferenceType> parameters);
	...
	public static ReferenceType fromReflectType(java.lang.reflect.Type reflectType) {
		...
		if (reflectType instanceof GenericArrayType genericArrayType) {
			return fromReflectType(genericArrayType.getGenericComponentType()).arrayType();
		}
