...
public class DefiniteGenericType extends GenericType {
	...
	/* package-visible */
	static DefiniteGenericType of(String encodedName, String name, ReferenceType superType, @Immutable List<? extends ReferenceType> interfaces) {
	...
	public String toString() {
		return "def(" + name + ')' /* + " extends " + superType + (interfaces.isEmpty() ? "" : " implements " +
