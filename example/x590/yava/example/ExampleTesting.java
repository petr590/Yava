...
import x590.yava.example.assembling.AssemblingExampleTesting;
import x590.yava.example.decompiling.DecompilationExampleTesting;
import x590.yava.example.disassembling.DisassemblingExampleTesting;
...
public abstract class ExampleTesting {
	...
	public ExampleTesting(String postfix) {
		this.postfix = postfix;
	}

	public static final String
			// IntelliJ IDEA
			DEFAULT_DIR = "out/example/yava",
