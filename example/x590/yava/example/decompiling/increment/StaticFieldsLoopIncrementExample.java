package x590.yava.example.decompiling.increment;
...
public class StaticFieldsLoopIncrementExample {

	public static void main(String[] args) {
		ExampleTesting.DECOMPILING.run(StaticFieldsLoopIncrementExample.class);
	}
